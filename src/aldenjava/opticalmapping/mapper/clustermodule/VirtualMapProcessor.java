...
public class VirtualMapProcessor {
	...
	private final boolean transloc;
	public VirtualMapProcessor(LinkedHashMap<String, DataNode> optrefmap, int indelPenalty, int inversionPenalty, int translocationPenalty, PathBuilderFilter indelFilter, PathBuilderFilter inversionFilter, int match, int fpp, int fnp, boolean localPenalty, boolean transloc)
	{
		super();
	...
	public int calcPenalty(OptMapResultNode map1, OptMapResultNode map2) {
		...
		// Modified at 20151012, Set boundary for indel / insertion penalty. 
		// If ResultClusterModule does not allow translocation, this module will still use the translocation penalty as upper limit
		if (transloc)
			if (penalty > translocationPenalty)
				penalty = translocationPenalty; 
